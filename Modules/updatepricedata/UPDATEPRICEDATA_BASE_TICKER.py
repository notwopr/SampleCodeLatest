...
1.3: change reference to exchanges from NYS/NAS to XNYS/XNAS respectively due to api changes.
"""
...
def storealltickers(destfolder, tickerfilename_all, tickerfilename_common):
    ...
    alltickers = list(filter(lambda x: x["exchange"] == "XNAS" or x["exchange"] == "XNYS", ticklist))
