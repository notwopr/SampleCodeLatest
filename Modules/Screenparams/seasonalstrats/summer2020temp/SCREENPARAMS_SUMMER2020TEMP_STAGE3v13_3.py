...
squeezew = 1/4/2                # weight of the squeeze metrics combined
slopew = 0                  # weight of the slopescore metric
sqaw = 1/4/2                # weight of squeezearea metric
pnegsegw = 1/4        # posnegseg metrics
posnegmagw = 1/4      # posnegmag metrics
posnegprevw = 1/4     # posnegprev metrics
kneew = 0                # weight of the bmknee metrics combined
...
fnlbatches = [
    {
        ...
        'batchtype': 'layercake',
        'batchname': 'summer2020temp_stage3v13_3'
    }
]
