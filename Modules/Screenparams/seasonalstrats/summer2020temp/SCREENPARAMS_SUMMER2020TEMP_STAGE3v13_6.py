...
squeezew = 1/6/2                # weight of the squeeze metrics combined
slopew = 1/6                  # weight of the slopescore metric
sqaw = 1/6/2                # weight of squeezearea metric
pnegsegw = 1/6        # posnegseg metrics
posnegmagw = 1/6      # posnegmag metrics
posnegprevw = 1/6     # posnegprev metrics
kneew = 1/6                # weight of the bmknee metrics combined
flatw = 0                # weight of the flat metrics combined
...
fnlbatches = [
    {
        ...
        'batchtype': 'layercake',
        'batchname': 'summer2020temp_stage3v13_6'
    }
]
