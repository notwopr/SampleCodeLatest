...
squeezew = 1/8                # weight of the squeeze metrics combined
slopew = 1/8                  # weight of the slopescore metric
sqaw = 1/8                # weight of squeezearea metric
pnegsegw = 1/8        # posnegseg metrics
posnegmagw = 1/8      # posnegmag metrics
posnegprevw = 1/8     # posnegprev metrics
kneew = 1/8                # weight of the bmknee metrics combined
flatw = 1/8                # weight of the flat metrics combined
...
fnlbatches = [
    {
        ...
        'batchtype': 'layercake',
        'batchname': 'summer2020temp_stage3v13_9'
    }
]
