...
4: Just recode to comply with new strattest function. reset upper bound of squeezearea to 1.  Removed unisqueezefactor_median and removed age requirement.
...
squeezearea > 0 and < 1
"""
from STRATTEST_FUNCBASE_RAW import dpc_cruncher_single, flatline_single, segliferatio_single
from STRATTEST_FUNCBASE_MMBM import fatarea_single
