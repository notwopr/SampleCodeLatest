...
Version: 4.00
Version Start Date: Feb 23, 2021
...
scriptlist = [
    ...
    {
        'scriptnickname': 'groplusvolv2',
        'scriptfilename': 'Screenparams.SCREENPARAMS_STAGE3_GROWTHPLUSVOLATILITYv2',
        'scriptweight': qualitymetricweight
    }
]

recoverybot_params = scriptjoiner(scriptlist, 'recoverybotv4')
