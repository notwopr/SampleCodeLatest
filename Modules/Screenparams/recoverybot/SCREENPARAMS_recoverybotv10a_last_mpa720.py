...
scriptlist = [
    {
        'scriptnickname': f'currtoathcombo_ascending_{ath_occur}_mpa{min_preath_age}',
        'scriptfilename': (f'Modules.Screenparams.recoverybot.SCREENPARAMS_currtoathcombo_ascending_{ath_occur}_mpa{min_preath_age}', 'stage3_params'),
...
recoverybot_params = scriptjoiner(scriptlist, f'recoverybotv10a_{ath_occur}_mpa{min_preath_age}')
