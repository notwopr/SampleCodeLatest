...
scriptlist = [
    {
        'scriptnickname': 'currtoathdays_ascending',
        'scriptfilename': 'Modules.Screenparams.recoverybot.SCREENPARAMS_currtoathdays_ascending',
...
recoverybot_params = scriptjoiner(scriptlist, 'recoverybotv10a')
