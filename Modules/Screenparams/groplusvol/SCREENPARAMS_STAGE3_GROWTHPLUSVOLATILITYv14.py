...
unifatvolscore
"""
from STRATTEST_FUNCBASE_MMBM import unifatshell_single, dropscore_single, slopetounifatratio_single, slopetodropscoreratio_single, unifatvolscore_single
from STRATTEST_FUNCBASE_RAW import slopescorefocus_single, currprice_single
...
currpriceweight = 0
stage3_params = {
    'scriptname': 'STAGE3_groplusvolv14',
    'scriptparams': [
        {
        ...
        },
        {
            ...
            'threshold': 0,
            'filterdirection': 'no',
            'metricweight': unifatvolscoreweight,
            'focuscol': 'rawprice',
            'calibration': ['baremaxraw'],
            'data': '',
            'look_back': 0
