...
15h: removed currentprice and dropscoreratio because caused zero division error in strattester when using benchmark that existed after a date
1/3 GROWTH
...
NO WEIGHT (INFO ONLY) -- REMOVED WITH 15H
    currentprice
    dropscoreratio
"""
from Modules.metriclibrary.STRATTEST_FUNCBASE_MMBM import slopetounifatratiobmin_single, unifatshell_single, allpctdrops_single
from Modules.metriclibrary.STRATTEST_FUNCBASE_RAW import slopescorefocus_single, statseglen_single, posnegmag_single
...
stage3_params = {
    'scriptname': 'STAGE3_groplusvolv15h',
    'scriptparams': [
        {
