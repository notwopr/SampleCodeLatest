...
NO WEIGHT (INFO ONLY)
    ...
    dropscoreratio
"""
from STRATTEST_FUNCBASE_MMBM import slopetounifatratiobmin_single, dropscore_single, allpctdrops_single, dropscoreratio_single
...
stage3_params = {
    'scriptname': 'STAGE3_groplusvolv15d',
    'scriptparams': [
        {
