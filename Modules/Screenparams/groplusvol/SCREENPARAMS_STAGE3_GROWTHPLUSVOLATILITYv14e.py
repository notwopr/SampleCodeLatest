...
Version: Same as 14d except two separate lookback period regimes. a shorter time period for all growth metrics like ratio, and slopescore, but a longer time period for smoothness.
1/3 GROWTH
...
stage3_params = {
    'scriptname': 'STAGE3_groplusvolv14e',
    'scriptparams': [
        {
