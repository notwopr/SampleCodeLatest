...
dropscoreweight = (1/4)*(1/2)*(1/2)
bmaxflatsegweight = (1/4)*(1/2)*(1/2)
maxdropweight = (1/4)*(1/2)*(1/2)
posnegmag_negavgweight = (1/4)*(1/2)*(1/2)
accretionscoreweight = (1/2)*(1/2)
slopescoreweight = 1/2
stage3_params = {
    'scriptname': 'smoothness_rankstagev9m_REV',
