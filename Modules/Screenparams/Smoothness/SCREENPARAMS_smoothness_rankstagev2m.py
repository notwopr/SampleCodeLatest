...
bminweight = 1/11
trueweight = 1/11
accretionscoreweight = 1/11
posnegmag_negavgweight = 1/11
posnegprevalence_negweight = 1/11
posnegmagratioweight = 1/11
avgnegseglenweight = 1/11
psegnegsegratioweight = 1/11
consecsegprevweight = 1/11
maxdropweight = 1/11
stage3_params = {
    'scriptname': 'smoothness_rankstagev2m',
    'scriptparams': [
        {
