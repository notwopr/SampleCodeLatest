...
bmaxweight = 1/10
bminweight = 1/10
accretionscoreweight = 1/10
posnegmag_negavgweight = 1/10
posnegprevalence_negweight = 1/10
posnegmagratioweight = 1/10
avgnegseglenweight = 1/10
psegnegsegratioweight = 1/10
consecsegprevweight = 1/10
maxdropweight = 1/10
stage3_params = {
    'scriptname': 'smoothness_rankstagev2i',
    'scriptparams': [
        {
