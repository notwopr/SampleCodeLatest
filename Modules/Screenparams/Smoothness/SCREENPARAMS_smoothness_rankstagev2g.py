...
STEP 3:
RANK HOW CLOSELY THE POSITIVE CURVE HUGS A STRAIGHT LINE - 1/3
+
NEGDPC 1/9
    AVG NEGDPC tradeonlydpc 1/3
    negdpc prev 1/3
    posnegmagratio tradeonlydpc 1/3
+
CONSECDPC 1/9
    AVG NEG 1/3
    PSEGNEGSEGRATIO 1/3
    consecsegprev_neg 1/3
+
maxdrop 1/9
+
ACCRETIONSCORE - 1/3
...
posnegmag_negavgweight = 1/27
posnegprevalence_negweight = 1/27
posnegmagratioweight = 1/27
avgnegseglenweight = 1/27
psegnegsegratioweight = 1/27
consecsegprevweight = 1/27
maxdropweight = 1/9
stage3_params = {
    'scriptname': 'smoothness_rankstagev2g',
    'scriptparams': [
        {
