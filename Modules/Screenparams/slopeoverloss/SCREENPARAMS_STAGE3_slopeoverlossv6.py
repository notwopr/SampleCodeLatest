...
scriptlist = [
    {
        'scriptnickname': 'slopeoverlossv4',
        'scriptfilename': 'Screenparams.SCREENPARAMS_STAGE3_slopeoverlossv4',
        'scriptweight': 0.5
    },
    {
...
stage3_params = scriptjoiner(scriptlist, 'STAGE3_slopeoverlossv6')
