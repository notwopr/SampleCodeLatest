...
Description:
avg 1/2
    slopeoverloss_sum_avg
slopeoverloss_sum_max 1/2
...
scriptlist = [
    {
        'scriptnickname': 'slopeoverlossv12',
        'scriptfilename': 'Screenparams.SCREENPARAMS_STAGE3_slopeoverlossv12',
        'scriptweight': 0.5
    },
    {
...
stage3_params = scriptjoiner(scriptlist, 'STAGE3_slopeoverlossv14')
