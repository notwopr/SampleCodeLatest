"""
Title: SCREENPARAMS - STAGE 3 - bmintostraight_reg
...
stage3_params = {
    'scriptname': 'STAGE3_bmintostraight_reg',
    'scriptparams': [
        {
            'metricname': 'unifatscore_bminstraight_std',
            'rankascending': 1,
            'threshold': 0.10,
        ...
        {
            'metricname': 'unifatscore_bminstraight_mad',
            'rankascending': 1,
            'threshold': 0.10,
            'thresholdtype': 'absolute',
            'filterdirection': 'no',
