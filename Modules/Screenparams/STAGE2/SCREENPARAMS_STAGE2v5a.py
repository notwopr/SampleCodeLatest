...
from STRATTEST_FUNCBASE_RAW import age_single, currprice_single, slopescorefocus_single

# DEFINE STRUCTURE AND ORDER OF FILTERS AND LAYERS TO APPLY
stage2_params = {
    'scriptname': 'STAGE2FILTERSv5a',
    'scriptparams': [
        {
        ...
        },
        {
            ...
            'thresholdtype': 'absolute',
            'lowerthreshold': 120,
            'upperthreshold': 365*7,
            'filterdirection': 'betweeninclusive',
            'metricweight': 1,
            'calibration': [],
            'data': '',
            'look_back': 0
