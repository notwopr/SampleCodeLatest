...
def run_strat_sequential(bp):
    ...
    # save to file
    savetopkl(f'strattester_allperiodstatdf_{bp["todaysdate"]+bp["testnumber"]}', Path(DirPaths().strattester_allperiodstatdf), allperiodstatdf)
    savetopkl(f'strattester_stockperfreports_{bp["todaysdate"]+bp["testnumber"]}', Path(DirPaths().strattester_stockperfreports), stockperfdfreports)
